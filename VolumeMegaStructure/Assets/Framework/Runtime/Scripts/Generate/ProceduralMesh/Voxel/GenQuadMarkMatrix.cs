...
namespace VolumeMegaStructure.Generate.ProceduralMesh.Voxel
{
	...
	public struct GenQuadMarkMatrix : IJobParallelFor
	{
		...
		[NativeDisableParallelForRestriction] [WriteOnly] public NativeList<QuadMark>.ParallelWriter quad_mark_list;
		...
		public void Execute(int volume_i)
		{
			...
			var y_forward_inside = volume_inside_matrix[x + 1, y, z];
