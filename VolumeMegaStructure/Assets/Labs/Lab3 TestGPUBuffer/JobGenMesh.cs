...
namespace Labs.Lab3_TestGPUBuffer
{
    ...
    #region Job
        ...
        [BurstCompile]
        public struct Quad6IndexBufferJob : IJobParallelFor
        {
            static readonly int[] LOCAL_INDEX_BUFFER = { 0, 1, 2, 2, 3, 0 };
        ...
        {
            static readonly float3 forward = new(0, 0, 1);
            public NativeArray<float3> vertex_buffer;
    ...
    #region Process
        ...
        void GenMesh()
        {
            ...
            var index_job = new Quad6IndexBufferJob
            {
