...
namespace Tests
{
    ...
    public class VoxelGenerator : MonoBehaviour
    {
        ...
        private Dictionary<Vector3 , int> QuadCenterToIndexDictionary;
        ...
        private VolumeMatrix<float> volume_matrix;
        ...
        private void GenerateVolumeMatrix ()
        {
